...
static void benchmark_copy_bla(benchmark::State& state) {
...
BENCHMARK(benchmark_copy_bla)->RangeMultiplier(2)->Range(BENCHMARK_MIN_SIZE, BENCHMARK_MAX_SIZE)->UseRealTime();
