...
static void benchmark_mm_bla_rowsplit(benchmark::State& state) {
...
BENCHMARK(benchmark_mm_bla_rowsplit)->RangeMultiplier(2)->Range(BENCHMARK_MIN_SIZE, BENCHMARK_MAX_SIZE)->UseRealTime();
